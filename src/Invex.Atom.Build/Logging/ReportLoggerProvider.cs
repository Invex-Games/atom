...
/// </summary>
internal sealed class ReportLoggerProvider(IServiceProvider serviceProvider) : ILoggerProvider
{
    ...
    public ILogger CreateLogger(string categoryName) =>
        _loggers.GetOrAdd(categoryName, new ReportLogger(serviceProvider, _scopeProvider));
