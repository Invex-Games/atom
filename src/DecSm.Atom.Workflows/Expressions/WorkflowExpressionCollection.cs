...
public sealed class WorkflowExpressionCollection : IEnumerable<WorkflowExpression>
{
    ...
    public static implicit operator WorkflowExpressionCollection(WorkflowExpression expression) =>
        new([expression]);
    ...
    public static implicit operator WorkflowExpressionCollection(string value) =>
        new([WorkflowExpressions.Raw(value)]);
