...
)
{
    ...
    /// <exception cref="BuildConfigurationException">Thrown when duplicate target names are detected.</exception>
    /// <exception cref="BuildConfigurationException">Thrown when a target depends on a non-existent target.</exception>
    /// <exception cref="BuildConfigurationException">Thrown when circular dependencies are detected between targets.</exception>
