...
/// </summary>
internal sealed class SpectreLoggerProvider(IServiceProvider serviceProvider) : ILoggerProvider
{
    ...
    public ILogger CreateLogger(string categoryName) =>
        _loggers.GetOrAdd(categoryName, new SpectreLogger(categoryName, serviceProvider, _scopeProvider));
