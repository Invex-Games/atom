...
{
    private const string ConfigureHostBuilderAttributeFull = "DecSm.Atom.Build.Hosting.ConfigureHostBuilderAttribute";
    private const string ConfigureHostAttributeFull = "DecSm.Atom.Build.Hosting.ConfigureHostAttribute";
