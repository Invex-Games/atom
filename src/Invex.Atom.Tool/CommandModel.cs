...
/// <summary>
///     Defines the command-line interface (CLI) commands available in the Invex.Atom.Tool.
/// </summary>
/// <remarks>
///     This class uses ConsoleAppFramework to expose various functionalities,
///     allowing users to interact with Invex.Atom projects and NuGet configurations
...
internal sealed class CommandModel
{
    ...
    /// <param name="runArgs">
    ///     Optional. Arguments to pass directly to the Invex.Atom build project.
    ///     These arguments are typically used to specify targets or parameters for the build.
    /// </param>
    /// <param name="project">
    ///     Optional. The name of the Invex.Atom project or file-based app to run. Defaults to "_atom".
    ///     This allows specifying which build definition to execute within a multi-project solution.
    /// </param>
    /// <param name="file">
    ///     Optional. The path to a C# file to run as a file-based Invex.Atom application.
    /// </param>
    ...
    /// <returns>The exit code of the executed Invex.Atom build command.</returns>
    [Command("")]
